        ...
        <div className="terminal-window">
          <div className="terminal-header">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-terminal-green font-terminal text-sm">MOE_WELCOME_PROTOCOL</span>
            </div>
          </div>
          <div className="terminal-content space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div className="space-y-2">
                <p className="text-terminal-green font-terminal text-lg">
                  GREETINGS, AGENT.
                </p>
                <p className="text-terminal-green/90 font-mono text-sm leading-relaxed">
                  I'm <span className="text-terminal-green font-terminal">MOE</span> - your Mission-Oriented Expert. 
                ...
                <p className="text-terminal-green/90 font-mono text-sm leading-relaxed">
                  ...
                  <span className="text-terminal-green"> Upload your files and let's solve this together.</span>
                </p>
              </div>
            </div>
            
            <div className="flex items-center space-x-2 pt-2 border-t border-terminal-green/20">
